export class reemNewFaseDosModelo {
  constructor(
    ...
    public reem_moneda_nombre:string,
    public reem_moneda_decimales:string,
    public reem_tipo_cambio_string:string,
    public reem_importe_resultante:string,
    ...
    public factura_xml_name:string,
    public factura_pdf_name:string,
  ) { }
}