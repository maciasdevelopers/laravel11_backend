...
@Component({
  ...
  templateUrl: './aportaciones_alta.component.html',
  standalone:false,
  styleUrls: [
    ...
    '../../../../../../../styles/landing.css',
    '../../../../contabilidad.css',
    './aportaciones_alta.component.css']
})

export class AportacionesAltaComponent implements OnInit {
  options = {};
  ...
  public impuestotipoSelectedToken:string;
  public impuestotipoSelected:string;
  ...
  constructor(public renderer: Renderer2,
    ...
    public _clientServ: ClientesService) {
      this.impuestotipoSelectedToken = '';
      this.impuestotipoSelected = 'seleccione un impuesto de la lista de federales estatales y locales';
