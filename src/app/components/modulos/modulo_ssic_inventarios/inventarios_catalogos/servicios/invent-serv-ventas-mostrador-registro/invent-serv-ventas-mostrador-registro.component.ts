...
@Component({
  selector: 'app-inventarios-servicios-ventas-mostrador-registro',
  templateUrl: './invent-serv-ventas-mostrador-registro.component.html',
  standalone:false,
  styleUrls: [
    ...
    '../../../../../../styles/switches.css',
    '../../../inventarios.css',
    './invent-serv-ventas-mostrador-registro.component.css'
  ],
  encapsulation: ViewEncapsulation.None,
})

export class InventServVentasMostradorRegistroComponent implements OnInit {
