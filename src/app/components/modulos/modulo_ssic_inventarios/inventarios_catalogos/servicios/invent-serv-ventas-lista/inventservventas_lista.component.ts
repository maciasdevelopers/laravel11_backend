...
@Component({
  selector: 'app-invent-serv-ventas-lista',
  templateUrl: './inventservventas_lista.component.html',
  standalone:false,
  styleUrls: [
    ...
    '../../../../../../styles/colores.css',
    '../../../inventarios.css',
    './inventservventas_lista.component.css'
  ],
  encapsulation: ViewEncapsulation.None,
})

export class InventServVentasListaComponent implements OnInit {
  //buscadores
  public usuario: Usuarios;
  listaServTrueVentas:any = [];
  ...
  ngOnInit(): void {
    this.listaServiciosGeneral();
  }

  listaServiciosGeneral(){
    this._servicioServ.InventariosCatalogosGeneralCatalogoServ().subscribe(
      response => {
        if (response.status == 'success') {
          this.listaServTrueVentas = response.datosServicio;
          console.log(this.listaServTrueVentas);
        }
      },
      error => {
        console.log(error);
  ...
  verServicioVentas(token_cat_servicios:any){
    this.relInterna.mensajeVerServVentas("ver servicio",token_cat_servicios);
  }
